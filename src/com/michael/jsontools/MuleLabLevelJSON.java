...
public class MuleLabLevelJSON
{
	...
	public String toString()
	{
		return  "{\n"+
				...
				"\t"+JSONTools.keyValuePair("copy", "((not(ingroup('demonstrator','lecturer')))?'workbook':'system')")+",\n"+
				"\t"+JSONTools.keyValuePair("paste", "((not(ingroup('demonstrator','lecturer')))?'workbook':'system')")+"\n"+
				"}";
	}
}